...
def build_detection_test_loader(cfg, dataset_name, mapper=None):
    ...
    if cfg.DATASETS.TEST_NUMBER != 0:
        dataset_dicts = dataset_dicts[:cfg.DATASETS.TEST_NUMBER]
        logging.info('Dataset will only use {} number of images for test'.format(cfg.DATASETS.TEST_NUMBER))
